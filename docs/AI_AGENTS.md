...
```sh
npx --yes --ignore-scripts remote-latexmk@0.4.2 auth login --server https://latex.example.edu
```
...
```sh
npx --yes --ignore-scripts remote-latexmk@0.4.2 agent install \
...
```sh
npx --yes --ignore-scripts remote-latexmk@0.4.2 \
