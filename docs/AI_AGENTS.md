...
```sh
npx --yes --ignore-scripts remote-latexmk@0.4.5 auth login --server https://latex.example.edu
```
...
```sh
npx --yes --ignore-scripts remote-latexmk@0.4.5 agent install \
...
```sh
npx --yes --ignore-scripts remote-latexmk@0.4.5 \
